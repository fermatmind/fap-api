...
final class ReviewPolicyRegistry
{
    ...
    private const SURFACES = [
        ...
        ['mbti_approval_batch', 'personality', 'R1', 'App\\Services\\Cms\\PersonalityApprovalQueueWriter', 'private_only', false, 'SOLO-OWNER-PERSONALITY-REVIEW-03'],
        ...
        ['seo_agent_draft_review', 'seo', 'R1', 'App\\Services\\SeoAgentGovernance\\SeoRoleCapabilityRegistry', 'private_only', false, 'SOLO-OWNER-CAREER-SEO-REVIEW-04'],
        ['seo_canary_approval', 'seo', 'R2', 'App\\Services\\Cms\\ArticlePublishService', 'private_only', false, 'SOLO-OWNER-CAREER-SEO-REVIEW-04'],
        ['search_submission_queue_approval', 'seo', 'R2', 'App\\Services\\SeoIntel', 'private_only', false, 'SOLO-OWNER-CAREER-SEO-REVIEW-04'],
        ['seo_claim_risk_review', 'seo', 'R4', 'App\\Services\\SeoAgentGovernance\\SeoRoleCapabilityRegistry', 'private_only', true, 'SOLO-OWNER-CAREER-SEO-REVIEW-04'],
        ['content_package_approval', 'seo', 'R2', 'App\\Services\\SeoAgentGovernance\\SeoRoleCapabilityRegistry', 'private_only', false, 'SOLO-OWNER-CAREER-SEO-REVIEW-04'],
