...
const expectedCodes = ["warmth", "gregariousness", "assertiveness", "activity", "excitement-seeking", "positive-emotions"];
...
const [ledger, raw, review, repaired, seed] = await Promise.all([
  ...
  readJson("repaired_draft.json"), readJson("big_five_en_facet_extraversion_seed.json"),
]);
...
assert(expectedCodes.every((code) => seed.assets.some((asset) => asset.entity_key === code)), "Extraversion Facet coverage mismatch");
...
assert(ledger.taxonomy.length === 1 && ledger.taxonomy[0].facets.length === 6, "Extraversion ledger taxonomy mismatch");
...
const qaReport = {
  ...
  model_sessions: [
    { id: "codex-native-en-extraversion-raw-2026-07-11", mode: "codex_native_draft", external_model: false },
    { id: "codex-skeptical-review-en-extraversion-2026-07-11", mode: "codex_skeptical_self_review", external_model: false },
    { id: "codex-repair-en-extraversion-2026-07-11", mode: "codex_repair", external_model: false },
  ],
