...
const expectedCodes = ["trust", "straightforwardness", "altruism", "compliance", "modesty", "tender-mindedness"];
...
const [ledger, raw, review, repaired, seed] = await Promise.all([
  ...
  readJson("repaired_draft.json"), readJson("big_five_en_facet_agreeableness_seed.json"),
]);
...
assert(expectedCodes.every((code) => seed.assets.some((asset) => asset.entity_key === code)), "Agreeableness Facet coverage mismatch");
...
assert(ledger.taxonomy.length === 1 && ledger.taxonomy[0].facets.length === 6, "Agreeableness ledger taxonomy mismatch");
...
const qaReport = {
  ...
  model_sessions: [
    { id: "codex-native-en-agreeableness-raw-2026-07-11", mode: "codex_native_draft", external_model: false },
    { id: "codex-skeptical-review-en-agreeableness-2026-07-11", mode: "codex_skeptical_self_review", external_model: false },
    { id: "codex-repair-en-agreeableness-2026-07-11", mode: "codex_repair", external_model: false },
  ],
