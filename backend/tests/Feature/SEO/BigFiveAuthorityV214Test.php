...
class BigFiveAuthorityV214Test extends TestCase
{
    private const DIR = 'generated/big-five-authority-v2/big5-authority-v2-range-neuroticism-14';
    ...
    public function test_package_workflow_passes_with_eight_pages_and_closed_release_gates(): void
    {
        ...
        $this->assertSame([
            '/en/personality/big-five/emotional-stability',
            '/en/personality/big-five/high-neuroticism',
            '/en/personality/big-five/neuroticism-high',
            '/en/personality/big-five/neuroticism-low',
            '/en/personality/big-five/neuroticism-mid',
            '/zh/personality/big-five/neuroticism-high',
            '/zh/personality/big-five/neuroticism-low',
            '/zh/personality/big-five/neuroticism-mid',
    ...
    public function test_final_package_preserves_v2_locale_pairs_and_distinct_legacy_intents(): void
    {
        ...
        $this->assertSame([
            'threat_signal_and_recovery_calibration',
            'steady_response_and_early_warning_protocol',
        ], $legacyIntents);
        $this->assertStringContainsString('conditional reactivity pattern', $v2Pairs['middle']['en']['summary']);
        $this->assertStringContainsString('条件性反应模式', $v2Pairs['middle']['zh-CN']['summary']);
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'big5-authority-v2-range-neuroticism-');
