...
### 2.1 规范与口径
- API 规范：docs/03-stage1/api-v0.3-spec.md
- 术语词典：docs/03-stage1/fap-v0.3-glossary.md
...
- [ ] API v0.3 的 envelope/错误码/路径风格在文档中明确
...
- API 规范：docs/03-stage1/api-v0.3-spec.md
- 术语口径：docs/03-stage1/fap-v0.3-glossary.md
