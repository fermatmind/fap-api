...
final class EnneagramPublicAuthorityV2IntegrityGate
{
    ...
    private function hasExplicitNegativePrefix(string $prefix, string $claim): bool
    {
        ...
        $boundedEnglishScope = '(?!\s+(?:only|merely|just|simply|solely|exactly|necessarily)\b)(?:(?!\b(?:and|also|plus|additionally|furthermore|moreover|then|while|whereas|but|however|yet|before|after|because|since|although|though|unless|until|if|when|where|which|who|whose|that|so)\b|,\s*(?:(?:and|or)\s+)?(?:it|this|that|the\s+page|we|you|they|he|she|there)\b|[.!?;:\n]).){0,100}';
