...
final class MigrationPurityGateTest extends TestCase
{
    ...
    private const LEGACY_FILE_ALLOWLIST = [
        ...
        // AssessmentEnglishLandingPublicationTest covers source binding, tenant preservation and atomic conflict rejection.
        ...
        // RiasecEnglishParityPublicationTest covers the two exact fields, two-registry parity, idempotence, and atomic rollback.
        '2026_09_21_010000_align_riasec_english_landing_parity.php',
    ];
