...
class PaymentEventPolicy
{
    ...
    public function view(mixed $user, PaymentEvent $record): bool
    {
        return $this->canRead($user, (int) $record->org_id);
    }

    public function update(mixed $user, PaymentEvent $record): bool
    {
        return $this->canWrite($user, (int) $record->org_id);
    }

    public function delete(mixed $user, PaymentEvent $record): bool
    {
        return $this->canWrite($user, (int) $record->org_id);
    }
}
