...
final class EnneagramPublicAuthorityV212Type3FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-3-family-12/type-3-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-3-family-12/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:3w2',
        'wing:3w4',
        'instinctual_subtype:type-3/self-preservation',
        'instinctual_subtype:type-3/social',
        'instinctual_subtype:type-3/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_three_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-3-FAMILY-12', $package['artifact']);
    ...
    public function test_core_pages_cover_type_three_performance_motive_boundary_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('3w2', $text, $key);
            $this->assertStringContainsString('3w4', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(41, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(41, array_sum($report['raw_draft_audit']['issues']));
        $this->assertSame(27, $report['raw_draft_audit']['repair_rounds'][0]['remaining_asset_specific_issue_count']);
