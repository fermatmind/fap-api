...
class BigFiveAuthorityV213Test extends TestCase
{
    private const DIR = 'generated/big-five-authority-v2/big5-authority-v2-range-agreeableness-13';
    ...
    public function test_package_workflow_passes_with_eight_pages_and_closed_release_gates(): void
    {
        ...
        $this->assertSame([
            '/en/personality/big-five/agreeableness-high',
            '/en/personality/big-five/agreeableness-low',
            '/en/personality/big-five/agreeableness-mid',
            '/en/personality/big-five/high-agreeableness',
            '/en/personality/big-five/low-agreeableness',
            '/zh/personality/big-five/agreeableness-high',
            '/zh/personality/big-five/agreeableness-low',
            '/zh/personality/big-five/agreeableness-mid',
    ...
    public function test_final_package_preserves_v2_locale_pairs_and_distinct_legacy_intents(): void
    {
        ...
        $this->assertSame([
            'helping_boundaries_and_reciprocity_audit',
            'direct_disagreement_and_repair_protocol',
        ], $legacyIntents);
        $this->assertStringContainsString('selective cooperation pattern', $v2Pairs['middle']['en']['summary']);
        $this->assertStringContainsString('选择性合作模式', $v2Pairs['middle']['zh-CN']['summary']);
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'big5-authority-v2-range-agreeableness-');
