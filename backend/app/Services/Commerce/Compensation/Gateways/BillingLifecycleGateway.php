...
final class BillingLifecycleGateway implements PaymentLifecycleGatewayInterface
{
    ...
    public function queryPaymentStatus(array $context): array
    {
        return [
            ...
            'reason' => 'billing provider query is not implemented in this project.',
        ];
    }
    ...
    public function closePayment(array $context): array
    {
        return [
            ...
            'is_terminal' => false,
            'supports_close' => false,
            'reason' => 'billing provider close is not implemented in this project.',
        ];
    }
}
