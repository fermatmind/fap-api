...
// ✅ 让 applyOverridesUnified() 内也能读到同一个 collector（保持签名不动）
if ($wantExplainPayload) {
...
$sections = [
    ...
    'relationships' => [
        ...
        Log::debug('[reads] enter ReportComposer::recommended_reads', [
  'attempt_id' => $attemptId ?? null,
  'type' => $typeCode ?? null,
  'pkg' => $contentPackageVersion ?? null,
  'refresh' => $ctx['refresh'] ?? null,
]);
