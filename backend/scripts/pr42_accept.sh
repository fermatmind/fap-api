...
ART_DIR="${BACKEND_DIR}/artifacts/pr42"
SERVE_PORT="${SERVE_PORT:-1842}"
DB_PATH="/tmp/pr42.sqlite"
...
SERVE_PORT="${SERVE_PORT}" ART_DIR="${ART_DIR}" bash "${BACKEND_DIR}/scripts/pr42_verify.sh"
...
bash "${BACKEND_DIR}/scripts/sanitize_artifacts.sh" 42

bash -n "${BACKEND_DIR}/scripts/pr42_accept.sh"
bash -n "${BACKEND_DIR}/scripts/pr42_verify.sh"
