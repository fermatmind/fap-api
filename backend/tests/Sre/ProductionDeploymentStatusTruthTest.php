...
final class ProductionDeploymentStatusTruthTest extends TestCase
{
    ...
    public function test_standard_staging_evidence_allows_only_audited_control_only_byte_equivalent_delta(): void
    {
        ...
        $this->assertStringContainsString('.github/workflows/mbti-comp-runtime46-production-ops.yml|.github/workflows/deploy-production.yml|backend/tests/Sre/DeployStorageAndDatabaseConfigTest.php|backend/tests/Sre/ProductionDeploymentStatusTruthTest.php)', $eligibility);
        $this->assertStringNotContainsString('.github/workflows/mbti-comp-runtime46-staging-dry-run.yml', $eligibility);
