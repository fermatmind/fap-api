@php
    ...
    $sectionLabel = match (true) {
        ...
        str_contains($routeName, 'content-release'),
        str_contains($routeName, 'content-pack-release'),
        str_contains($routeName, 'content-pack-version') => __('ops.group.content_release'),
        str_contains($routeName, 'content-overview'),
        str_contains($routeName, 'content-workspace'),
        str_contains($routeName, 'article-category'),
        str_contains($routeName, 'article-tag') => __('ops.group.content_data'),
        str_contains($routeName, 'article'),
        str_contains($routeName, 'career-job'),
        str_contains($routeName, 'career-guide') => __('ops.group.content_workspace'),
