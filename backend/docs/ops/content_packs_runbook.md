...
判定命令：
- php artisan fap:resolve-pack MBTI CN_MAINLAND zh-CN MBTI-CN-v0.2.1-TEST -vvv
  看到：
  - RESOLVED pack_id=MBTI.cn-mainland.zh-CN.v0.2.1-TEST
...
要求至少包含：
/var/www/fap-api/shared/content_packages/default/CN_MAINLAND/zh-CN/MBTI-CN-v0.2.1-TEST/
...
示例：
/var/www/fap-api/shared/content_packs_cache/MBTI-CN-v0.2.1-TEST/manifest.json
...
随后校验：
sudo ls -lah /var/www/fap-api/shared/content_packs_cache/MBTI-CN-v0.2.1-TEST/manifest.json
sudo ls -lah /var/www/fap-api/shared/content_packs_cache/MBTI-CN-v0.2.1-TEST/questions.json
sudo ls -lah /var/www/fap-api/shared/content_packs_cache/MBTI-CN-v0.2.1-TEST/scoring_spec.json
