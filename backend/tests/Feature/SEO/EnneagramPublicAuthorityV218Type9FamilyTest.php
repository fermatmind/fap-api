...
final class EnneagramPublicAuthorityV218Type9FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-9-family-18/type-9-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-9-family-18/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:9w8',
        'wing:9w1',
        'instinctual_subtype:type-9/self-preservation',
        'instinctual_subtype:type-9/social',
        'instinctual_subtype:type-9/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_nine_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-9-FAMILY-18', $package['artifact']);
    ...
    public function test_core_pages_cover_priority_conflict_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('9w8', $text, $key);
            $this->assertStringContainsString('9w1', $text, $key);
    ...
    public function test_subtype_pages_use_matched_comparisons_and_non_mechanistic_boundaries(): void
    {
        ...
        foreach ($subtypes as $asset) {
            ...
            $this->assertMatchesRegularExpression(
                $asset['locale'] === 'en' ? '/not describe bodily mechanisms|not evidence about bodily mechanisms|rather than evidence about bodily mechanisms/i' : '/不描述身体机制/u',
                $boundary['body'],
                $key,
            );
        }
    ...
    public function test_positive_review_release_and_mechanism_mutations_fail_closed(): void
    {
        ...
        $package['assets'][6]['sections'][4]['body'] = 'Self-preservation is a biological system and a neurological category that determines behavior.';
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertGreaterThan(0, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame($report['raw_draft_audit']['asset_specific_issue_count'], array_sum($report['raw_draft_audit']['issues']));
