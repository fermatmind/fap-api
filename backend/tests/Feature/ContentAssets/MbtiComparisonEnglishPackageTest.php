...
{
    private const PACKAGE_DIRECTORY = __DIR__.'/../../../content_assets/en-content-parity/W1-mbti/comparisons/w9-correction-01a5dd2e';
    ...
    private const REQUIRED_SOURCE_EQUIVALENT_LINKS = [
        'W1-COMP-01-ENFP-VS-ENTP' => [
            '/en/tests/big-five-personality-test-ocean-model',
            '/en/tests/holland-career-interest-test-riasec',
            '/en/personality/enfp-a-vs-enfp-t',
            '/en/personality/entp-a-vs-entp-t',
        ],
        'W1-COMP-03-ESTJ-VS-ENTJ' => [
            '/en/tests/big-five-personality-test-ocean-model',
            '/en/tests/holland-career-interest-test-riasec',
            '/en/personality/estj-a-vs-estj-t',
            '/en/personality/entj-a-vs-entj-t',
        ],
        'W1-COMP-06-ISFP-VS-INFP' => [
            '/en/tests/big-five-personality-test-ocean-model',
            '/en/tests/holland-career-interest-test-riasec',
            '/en/personality/isfp-a-vs-isfp-t',
            '/en/personality/infp-a-vs-infp-t',
        ],
        'W1-COMP-07-ISTJ-VS-ISFJ' => [
    ...
    public function it_freezes_the_exact_seven_asset_package_and_hashes(): void
    {
        ...
        self::assertSame('EN-PARITY-W1-MBTI-COMPARISON-ASSETS-W9-CORRECTION-04-2026-07-31', $manifest['package_id']);
        ...
        self::assertSame('01a5dd2e5f5c52545faadbea4b3b6b01cc4ddc73e8e653df3541926e475fbf4f', $manifest['package_sha256']);
    }
    ...
    public function it_preserves_source_structure_and_public_payload_alignment(): void
    {
        ...
        foreach ($package['assets'] as $asset) {
            ...
            foreach (self::REQUIRED_SOURCE_EQUIVALENT_LINKS[$asset['row_id']] ?? [] as $requiredHref) {
                self::assertContains(
                    $requiredHref,
                    array_column($payload['internal_links'], 'href'),
                    $asset['row_id'].' omitted the source-authoritative internal-link intent '.$requiredHref,
                );
            }
