...
use App\Http\Controllers\API\V0_5\Cms\DataPageController;
use App\Http\Controllers\API\V0_5\Cms\MethodPageController;
...
Route::prefix('v0.5')->group(function () {
    ...
    Route::get('/methods', [MethodPageController::class, 'index']);
    Route::get('/methods/{slug}/seo', [MethodPageController::class, 'seo']);
    Route::get('/methods/{slug}', [MethodPageController::class, 'show']);
    Route::get('/data', [DataPageController::class, 'index']);
    Route::get('/data/{slug}/seo', [DataPageController::class, 'seo']);
    Route::get('/data/{slug}', [DataPageController::class, 'show']);
