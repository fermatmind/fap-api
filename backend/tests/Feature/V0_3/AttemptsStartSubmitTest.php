...
class AttemptsStartSubmitTest extends TestCase
{
    ...
    public function test_mbti_report_locked_false(): void
    {
        $this->seedScales();
        ...
        $this->assertNotNull($report->json('report.profile'));
        $this->assertNotNull($report->json('report.scores'));
        $this->assertNotNull($report->json('report.sections'));
    }
}
