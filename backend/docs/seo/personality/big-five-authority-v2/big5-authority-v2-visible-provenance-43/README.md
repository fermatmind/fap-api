...
- A visible author requires a non-empty identity, public label, allowed role, and authority reference. Article metadata must agree with the matching published revision actor and any existing Article label.
