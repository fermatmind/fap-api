...
final class EnneagramPublicAuthorityV216Type7FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-7-family-16/type-7-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-7-family-16/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:7w6',
        'wing:7w8',
        'instinctual_subtype:type-7/self-preservation',
        'instinctual_subtype:type-7/social',
        'instinctual_subtype:type-7/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_seven_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-7-FAMILY-16', $package['artifact']);
    ...
    public function test_core_pages_cover_option_closure_discomfort_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('7w6', $text, $key);
            $this->assertStringContainsString('7w8', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(25, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(25, array_sum($report['raw_draft_audit']['issues']));
        $this->assertCount(2, $report['raw_draft_audit']['repair_rounds']);
        $this->assertSame(2, $report['raw_draft_audit']['repair_rounds'][0]['remaining_asset_specific_issue_count']);
