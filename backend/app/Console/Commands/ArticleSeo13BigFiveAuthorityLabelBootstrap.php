...
use App\Services\Cms\Seo13BigFiveAuthorityLabelBootstrapService;
 ...
 */
final class ArticleSeo13BigFiveAuthorityLabelBootstrap extends Command
{
    protected $signature = 'articles:seo13-big-five-authority-label-bootstrap
        {--dry-run : Inspect the exact two Big Five article authority labels without writes}
        {--execute : Apply the exact atomic authority-label bootstrap}
    ...
    protected $description = 'Atomically bootstrap missing author/reviewer labels for the exact two SEO 13 Big Five articles.';

    public function handle(Seo13BigFiveAuthorityLabelBootstrapService $service): int
    {
        ...
        $summary = [
            ...
            'target_count' => Seo13BigFiveAuthorityLabelBootstrapService::TARGET_COUNT,
        ...
        if (($summary['ok'] ?? false) === true && $execute) {
            try {
                ...
                $summary = array_merge($summary, [
                    ...
                    'article_metadata_write_count' => (int) ($writes['article_metadata_write_count'] ?? 0),
    ...
    {
        return 'I explicitly approve SEO 13 Big Five authority label bootstrap state '
    ...
    private function emit(array $summary): void
    {
        ...
        $this->info(($summary['ok'] ?? false) === true ? 'SEO13 Big Five authority label check passed.' : 'SEO13 Big Five authority label check failed.');
    }
}
