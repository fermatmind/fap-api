...
class ReportSnapshotB2CTest extends TestCase
{
    ...
    public function test_snapshot_created_by_payment_and_stable(): void
    {
        $this->seedScales();
        ...
        $payload = [
            'provider_event_id' => 'evt_b2c_1',
            'order_no' => $orderNo,
            'external_trade_no' => 'trade_b2c_1',
            'amount_cents' => 990,
            'currency' => 'USD',
        ];
        ...
        DB::table('scales_registry')
            ...
            ->where('code', 'MBTI')
            ->update([
                'default_dir_version' => 'MBTI-CN-v0.2.2-TEST',
                'updated_at' => now(),
            ]);
