...
final class EnneagramPublicAuthorityV217Type8FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-8-family-17/type-8-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-8-family-17/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:8w7',
        'wing:8w9',
        'instinctual_subtype:type-8/self-preservation',
        'instinctual_subtype:type-8/social',
        'instinctual_subtype:type-8/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_eight_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-8-FAMILY-17', $package['artifact']);
    ...
    public function test_core_pages_cover_authority_protection_autonomy_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('8w7', $text, $key);
            $this->assertStringContainsString('8w9', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(28, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(28, array_sum($report['raw_draft_audit']['issues']));
        $this->assertCount(2, $report['raw_draft_audit']['repair_rounds']);
