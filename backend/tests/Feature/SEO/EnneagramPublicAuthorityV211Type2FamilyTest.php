...
final class EnneagramPublicAuthorityV211Type2FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-2-family-11/type-2-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-2-family-11/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:2w1',
        'wing:2w3',
        'instinctual_subtype:type-2/self-preservation',
        'instinctual_subtype:type-2/social',
        'instinctual_subtype:type-2/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_two_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-2-FAMILY-11', $package['artifact']);
    ...
    public function test_core_pages_cover_type_two_motive_boundary_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('2w1', $text, $key);
            $this->assertStringContainsString('2w3', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(10, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(10, array_sum($report['raw_draft_audit']['issues']));
