...
class BigFiveAuthorityV212Test extends TestCase
{
    private const DIR = 'generated/big-five-authority-v2/big5-authority-v2-range-extraversion-12';
    ...
    public function test_package_workflow_passes_with_eight_pages_and_closed_release_gates(): void
    {
        ...
        $this->assertSame([
            '/en/personality/big-five/extraversion-high',
            '/en/personality/big-five/extraversion-low',
            '/en/personality/big-five/extraversion-mid',
            '/en/personality/big-five/high-extraversion',
            '/en/personality/big-five/low-extraversion',
            '/zh/personality/big-five/extraversion-high',
            '/zh/personality/big-five/extraversion-low',
            '/zh/personality/big-five/extraversion-mid',
    ...
    public function test_final_package_preserves_v2_locale_pairs_and_distinct_legacy_intents(): void
    {
        ...
        $this->assertSame([
            'social_energy_and_airtime_budget',
            'quiet_participation_and_recovery_plan',
        ], $legacyIntents);
        $this->assertStringContainsString('selective engagement pattern', $v2Pairs['middle']['en']['summary']);
        $this->assertStringContainsString('选择性参与模式', $v2Pairs['middle']['zh-CN']['summary']);
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'big5-authority-v2-range-extraversion-');
