        ...
        return [
            ...
            'required_evidence_checklist' => [
                ...
                'search_bridge' => [
                    ...
                    'enqueue_approval_phrase_template' => 'Historical only: Search Channel enqueue remains unavailable until seo.policy_gateway is implemented and separately authorized.',
            ...
            'future_command_templates' => [
                ...
                'publish_dry_run' => ['seo.release_separation:controlled_publish', 'execution_authorized=false'],
                'post_publish_propagation_dry_run' => ['seo.release_separation:runtime_readback', 'execution_authorized=false'],
                ...
                'search_bridge_dry_run' => ['seo.release_separation:search_queue_dry_run', 'execution_authorized=false'],
            ],
            'approval_boundaries' => [
