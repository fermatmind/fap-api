...
SERVE_PORT="${SERVE_PORT}" ART_DIR="${ART_DIR}" bash "${BACKEND_DIR}/scripts/pr40_verify.sh"
...
bash "${BACKEND_DIR}/scripts/sanitize_artifacts.sh" 40

bash -n "${BACKEND_DIR}/scripts/pr40_accept.sh"
bash -n "${BACKEND_DIR}/scripts/pr40_verify.sh"

echo "[PR40][PASS] acceptance complete"
