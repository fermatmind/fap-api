...
const [ledger, raw, review, repaired, seed] = await Promise.all([
  ...
  readJson("repaired_draft.json"), readJson("big_five_en_facet_neuroticism_seed.json"),
]);
...
const qaReport = {
  ...
  model_sessions: [
    { id: "codex-native-en-neuroticism-raw-2026-07-11", mode: "codex_native_draft", external_model: false },
    { id: "codex-skeptical-review-en-neuroticism-2026-07-11", mode: "codex_skeptical_self_review", external_model: false },
    { id: "codex-repair-en-neuroticism-2026-07-11", mode: "codex_repair", external_model: false },
  ],
