...
final class CareerDisplayWorkbookContractRepairer
{
    private const SHEET_NAME = CareerSelectedDisplayAssetMapper::SHEET_NAME;
     ...
     */
    public function repair(string $sourcePath, ?string $outputPath = null, bool $execute = false, array $slugs = []): array
    {
