...
use App\Services\Cms\Mbti64CrossTypeComparisonAssetsDryRunPlanner;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;
use RuntimeException;
use Throwable;

final class PersonalityMbti64CrossTypeComparisonAssetsDryRun extends Command
{
    protected $signature = 'personality:mbti64-cross-type-comparison-assets-dry-run
        {--source-dir=docs/seo/import-packages/mbti-cross-type-comparison-content-assets-draft-20260702 : Directory containing comparisons/*_CMS_READY.json}
        {--json : Emit the full JSON summary}
        {--output= : Optional path to write the JSON summary}';

    protected $description = 'Validate GPT-generated MBTI64 cross-type comparison content assets as a no-write CMS draft dry-run.';

    public function handle(Mbti64CrossTypeComparisonAssetsDryRunPlanner $planner): int
    {
        try {
