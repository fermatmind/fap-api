...
| Method | Path | Auth | Feature |
|---|---|---|---|
| `DELETE` | `/api/v0.2/memory/{id}` | `FmTokenAuth` | `insights` |
| `GET|HEAD` | `/api/v0.2/admin/audit-logs` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/content-releases` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/events` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/global-search` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/go-live-gate` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/healthz/snapshot` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/migrations/observability` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/migrations/rollback-preview` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/organizations` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/admin/queue/dlq/metrics` | `AdminAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/attempts/{attemptId}/report` | `FmTokenOptional` | `-` |
| `GET|HEAD` | `/api/v0.2/attempts/{attemptId}/result` | `FmTokenOptional` | `-` |
| `GET|HEAD` | `/api/v0.2/attempts/{id}/quality` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/attempts/{id}/share` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/attempts/{id}/stats` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/claim/report` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/content-packs` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/content-packs/{pack_id}/{dir_version}/manifest` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/content-packs/{pack_id}/{dir_version}/questions` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/health` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/healthz` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/insights/{id}` | `FmTokenOptional` | `insights` |
| `GET|HEAD` | `/api/v0.2/integrations/{provider}/oauth/callback` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/integrations/{provider}/oauth/start` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/lookup/ticket/{code}` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/me/agent/messages` | `FmTokenAuth` | `agent` |
| `GET|HEAD` | `/api/v0.2/me/agent/settings` | `FmTokenAuth` | `agent` |
| `GET|HEAD` | `/api/v0.2/me/attempts` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/me/data/mood` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/me/data/screen-time` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/me/data/sleep` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/me/identities` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/me/profile` | `FmTokenAuth` | `-` |
| `GET|HEAD` | `/api/v0.2/memory/export` | `FmTokenAuth` | `insights` |
| `GET|HEAD` | `/api/v0.2/memory/search` | `FmTokenAuth` | `insights` |
| `GET|HEAD` | `/api/v0.2/norms/percentile` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/questions` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/scale_meta` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/scales/MBTI` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/scales/MBTI/questions` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/scales/{scale}/norms` | `Public` | `-` |
| `GET|HEAD` | `/api/v0.2/share/{id}` | `FmTokenOptional` | `-` |
| `POST` | `/api/v0.2/admin/agent/disable-trigger` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/agent/replay/{user_id}` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/cache/invalidate` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/content-releases/publish` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/content-releases/rollback` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/content-releases/upload` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/content-releases/{id}/probe` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/go-live-gate/run` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/organizations` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/organizations/import-sync` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/admin/queue/dlq/replay/{failed_job_id}` | `AdminAuth` | `-` |
| `POST` | `/api/v0.2/attempts` | `Public` | `-` |
| `POST` | `/api/v0.2/attempts/start` | `Public` | `-` |
| `POST` | `/api/v0.2/attempts/{attempt_id}/feedback` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/attempts/{id}/result` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/attempts/{id}/start` | `Public` | `-` |
| `POST` | `/api/v0.2/auth/phone/send_code` | `Public` | `-` |
| `POST` | `/api/v0.2/auth/phone/verify` | `Public` | `-` |
| `POST` | `/api/v0.2/auth/provider` | `Public` | `-` |
| `POST` | `/api/v0.2/auth/wx_phone` | `Public` | `-` |
| `POST` | `/api/v0.2/events` | `Public` | `analytics` |
| `POST` | `/api/v0.2/insights/generate` | `FmTokenAuth` | `insights` |
| `POST` | `/api/v0.2/insights/{id}/feedback` | `FmTokenAuth` | `insights` |
| `POST` | `/api/v0.2/integrations/{provider}/ingest` | `Public` | `-` |
| `POST` | `/api/v0.2/integrations/{provider}/replay/{batch_id}` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/integrations/{provider}/revoke` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/lookup/device` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/lookup/order` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/me/agent/messages/{id}/ack` | `FmTokenAuth` | `agent` |
| `POST` | `/api/v0.2/me/agent/messages/{id}/feedback` | `FmTokenAuth` | `agent` |
| `POST` | `/api/v0.2/me/agent/settings` | `FmTokenAuth` | `agent` |
| `POST` | `/api/v0.2/me/bind-email` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/me/email/bind` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/me/email/verify-binding` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/me/identities/bind` | `FmTokenAuth` | `-` |
| `POST` | `/api/v0.2/memory/propose` | `FmTokenAuth` | `insights` |
| `POST` | `/api/v0.2/memory/{id}/confirm` | `FmTokenAuth` | `insights` |
| `POST` | `/api/v0.2/shares/{shareId}/click` | `FmTokenOptional` | `-` |
| `POST` | `/api/v0.2/webhooks/{provider}` | `Public` | `-` |
...
### 8) POST `/api/v0.2/me/identities/bind`
- Auth: `FmTokenAuth`
