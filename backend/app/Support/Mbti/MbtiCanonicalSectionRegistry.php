    ...
    public static function definitions(): array
    {
        return [
            ...
            'traits.why_this_type' => [
                ...
                'label' => 'Why This Type',
                'title' => 'Why this type',
                'description' => 'Explainability layer describing why the winning type pattern is structurally favored.',
                'sort_order' => 32,
                'enabled' => true,
            ],
            'traits.close_call_axes' => [
                ...
                'render_variant' => self::RENDER_VARIANT_RICH_TEXT,
                'group' => 'traits',
                'label' => 'Close Call Axes',
                'title' => 'Closest-call axes',
                'description' => 'Explainability layer describing which axes sit nearest the boundary and why they shift by context.',
                'sort_order' => 33,
                'enabled' => true,
            ],
            'traits.adjacent_type_contrast' => [
                ...
                'render_variant' => self::RENDER_VARIANT_RICH_TEXT,
                'group' => 'traits',
                'label' => 'Adjacent Type Contrast',
                'title' => 'Why you can resemble a nearby type',
                'description' => 'Explainability layer contrasting the result with the most likely neighboring type.',
                'sort_order' => 34,
                'enabled' => true,
            ],
            ...
            'career.work_experiments' => [
                ...
                'render_variant' => self::RENDER_VARIANT_RICH_TEXT,
                'group' => 'career',
                'label' => 'Work Experiments',
                'title' => 'Work experiments',
                'description' => 'Action-layer section turning work-fit signals into one or two reversible work experiments.',
                'sort_order' => 48,
                'enabled' => true,
            ],
            'career.advantages' => [
            ...
            'growth.stability_confidence' => [
                ...
                'render_variant' => self::RENDER_VARIANT_RICH_TEXT,
                'group' => 'growth',
                'label' => 'Stability And Confidence',
                'title' => 'Stability and confidence',
                'description' => 'Explainability layer for how stable the current type is and where context is most likely to change the visible pattern.',
                'sort_order' => 95,
                'enabled' => true,
            ],
            'growth.next_actions' => [
                ...
                'label' => 'Next Actions',
                'title' => 'Next actions',
                'description' => 'Action-layer section translating the current pattern into a concrete next growth move.',
                'sort_order' => 96,
                'enabled' => true,
            ],
            'growth.weekly_experiments' => [
                ...
                'description' => 'Action-layer section translating the current pattern into low-cost experiments for the coming week.',
                'sort_order' => 97,
                'enabled' => true,
            ],
            'growth.strengths' => [
            ...
            'growth.watchouts' => [
                ...
                'label' => 'Watchouts',
                'title' => 'Watchouts',
                'description' => 'Action-layer section highlighting the repeatable overuse patterns most worth catching early.',
                'sort_order' => 116,
                'enabled' => true,
            ],
            'growth.motivators' => [
            ...
            'relationships.try_this_week' => [
                ...
                'label' => 'Try This Week',
                'title' => 'Try this week',
                'description' => 'Action-layer section translating communication and boundary signals into a specific relationship practice for this week.',
                'sort_order' => 166,
                'enabled' => true,
            ],
