...
echo "[CI][scales] scale_scope=${SCALE_SCOPE} run_big5_ocean_gate=${RUN_BIG5_OCEAN_GATE} run_sds_20_gate=${RUN_SDS_20_GATE} run_full_scale_regression=${RUN_FULL_SCALE_REGRESSION}"
