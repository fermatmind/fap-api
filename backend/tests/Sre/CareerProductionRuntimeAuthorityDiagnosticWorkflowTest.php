...
final class CareerProductionRuntimeAuthorityDiagnosticWorkflowTest extends TestCase
{
    public function test_diagnostic_is_exact_main_runtime_user_read_only_and_pointer_receipt_bound(): void
    {
        ...
        foreach ([
            ...
            'actions/runs/31621136986',
            'actions/runs/31619963905',
            '7ff3deee3b5ea62afb4a1d917d0ff688207abccb',
            '4eabf49ab2a9de028afc80756faa5076138b8b6da0cf06eddd74f6ab2cd2d82e',
            "-r 'eval(base64_decode(\\\$argv[1]));'",
            ...
            'sudo -n -u www-data',
            'RUNTIME_IDENTITY_SWITCH_UNAVAILABLE',
            'REMOTE_PREFLIGHT_TRANSPORT_OR_STATE_INVALID',
            'RUNTIME_PROBE_RECEIPT_INVALID',
            'active_release_identity_observed',
            'runtime_identity_switch_available',
