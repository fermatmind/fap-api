...
final class SeoPlatform09ScheduledCloseoutTest extends TestCase
{
    ...
    {
        $receipt = $this->receiptService()->record('manual', CarbonImmutable::parse('2026-08-27T06:00:00Z'));
    ...
    public function natural_slot_is_idempotent_and_does_not_duplicate_selected_cards(): void
    {
        ...
        $slot = CarbonImmutable::parse('2026-08-27T06:00:00Z');
    ...
    public function migration_schedule_and_automatic_closeout_are_bounded_and_expand_only(): void
    {
        ...
        $this->assertMatchesRegularExpression('/seo:weekly-decisions --trigger=scheduled --json[\s\S]+weeklyOn\(4, \'06:00\'\)[\s\S]+withoutOverlapping\(120\)[\s\S]+onOneServer\(\)/', $bootstrap);
