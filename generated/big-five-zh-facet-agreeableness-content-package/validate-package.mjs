...
const [ledger, raw, review, repaired, seed] = await Promise.all([
  ...
  readJson("big_five_zh_facet_agreeableness_seed.json"),
]);
...
const qaReport = {
  ...
  model_sessions: [
    { id: "codex-native-agreeableness-raw-2026-07-10", mode: "codex_native_draft", external_model: false },
    { id: "codex-skeptical-review-agreeableness-2026-07-10", mode: "codex_skeptical_self_review", external_model: false },
    { id: "codex-repair-agreeableness-2026-07-10", mode: "codex_repair", external_model: false },
  ],
  coverage: {
    assets: 6,
    locale: "zh-CN",
  ...
  blockers: [],
  deferred: [
    "The remaining six Chinese Facet pages stay content_stub until their one domain PR complete.",
