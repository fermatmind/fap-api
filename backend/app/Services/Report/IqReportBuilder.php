...
final class IqReportBuilder
{
    ...
    public function build(Attempt $attempt, Result $result, string $variant = ReportAccess::VARIANT_FULL, array $ctx = []): array
    {
        ...
        return [
            ...
            'scoring' => [
                ...
                'beta_standard_score' => $summary['beta_standard_score'] ?? null,
                'beta_standard_score_status' => $summary['beta_standard_score_status'] ?? null,
                'beta_standard_score_source' => $summary['beta_standard_score_source'] ?? null,
                'random_baseline_mean' => $summary['random_baseline_mean'] ?? null,
                'random_baseline_sd' => $summary['random_baseline_sd'] ?? null,
                'random_baseline_z' => $summary['random_baseline_z'] ?? null,
                'above_random_baseline' => $summary['above_random_baseline'] ?? null,
                'production_normed' => $summary['production_normed'] ?? null,
                'claim_eligible' => $summary['claim_eligible'] ?? null,
                'population_percentile_eligible' => $summary['population_percentile_eligible'] ?? null,
                'source_kind' => $summary['source_kind'] ?? null,
    ...
    private function buildLockedReport(
        ...
        return [
            ...
            'summary' => [
                ...
                'beta_standard_score_status' => null,
                'beta_standard_score_source' => null,
                'random_baseline_mean' => null,
                'random_baseline_sd' => null,
    ...
    private function buildSummary(string $status, array $score): array
    {
        ...
        return [
            ...
            'beta_standard_score' => $this->intOrNull($score['beta_standard_score'] ?? null),
            'beta_standard_score_status' => $this->stringOrNull($score['beta_standard_score_status'] ?? null),
            'beta_standard_score_source' => $this->stringOrNull($score['beta_standard_score_source'] ?? null),
            'random_baseline_mean' => $this->floatOrNull($score['random_baseline_mean'] ?? null),
            'random_baseline_sd' => $this->floatOrNull($score['random_baseline_sd'] ?? null),
            'random_baseline_z' => $this->floatOrNull($score['random_baseline_z'] ?? null),
            'above_random_baseline' => is_bool($score['above_random_baseline'] ?? null)
                ? $score['above_random_baseline']
                : null,
            'production_normed' => ($score['production_normed'] ?? null) === true,
            'claim_eligible' => ($score['claim_eligible'] ?? null) === true,
            'population_percentile_eligible' => ($score['population_percentile_eligible'] ?? null) === true,
            'source_kind' => $this->stringOrNull($score['source_kind'] ?? null),
            'source_ref' => $this->stringOrNull($score['source_ref'] ?? null),
        ];
    }
