...
class BigFiveAuthorityV215Test extends TestCase
{
    private const DIR = 'generated/big-five-authority-v2/big5-authority-v2-facets-openness-15';
    ...
    /** @var list<string> */
    private const FACETS = ['imagination', 'aesthetics', 'feelings', 'actions', 'ideas', 'values'];
    ...
    public function test_package_workflow_passes_with_twelve_pages_and_closed_release_gates(): void
    {
        ...
        $this->assertSame([
            '/en/personality/big-five/facets/actions',
            '/en/personality/big-five/facets/aesthetics',
            '/en/personality/big-five/facets/feelings',
            '/en/personality/big-five/facets/ideas',
            '/en/personality/big-five/facets/imagination',
            '/en/personality/big-five/facets/values',
            '/zh/personality/big-five/facets/actions',
            '/zh/personality/big-five/facets/aesthetics',
            '/zh/personality/big-five/facets/feelings',
            '/zh/personality/big-five/facets/ideas',
            '/zh/personality/big-five/facets/imagination',
            '/zh/personality/big-five/facets/values',
    ...
    public function test_final_package_preserves_exact_facet_pairs_taxonomy_and_content_contract(): void
    {
        ...
        foreach ($package['pages'] as $page) {
            ...
            $this->assertSame('facet:openness:'.$page['facet_code'], $page['content_key']);
        ...
        $this->assertStringContainsString('mental imagery', $pairs['imagination']['en']['summary']);
        $this->assertStringContainsString('感官构成', $pairs['aesthetics']['zh-CN']['summary']);
        $this->assertStringContainsString('not empathy', $pairs['feelings']['en']['summary']);
        $this->assertStringContainsString('可撤销', $pairs['actions']['zh-CN']['low_risk_action']);
        $this->assertStringContainsString('not intelligence', $pairs['ideas']['en']['summary']);
        $this->assertStringContainsString('不等于道德', $pairs['values']['zh-CN']['summary']);
    ...
    {
        $package = $this->readJson(self::DIR.'/final-package.json');
        $package['pages'][0]['facet_code'] = 'ideas';
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'big5-authority-v2-facets-openness-');
