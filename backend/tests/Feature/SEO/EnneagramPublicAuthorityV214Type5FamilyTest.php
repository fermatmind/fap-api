...
final class EnneagramPublicAuthorityV214Type5FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-5-family-14/type-5-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-5-family-14/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:5w4',
        'wing:5w6',
        'instinctual_subtype:type-5/self-preservation',
        'instinctual_subtype:type-5/social',
        'instinctual_subtype:type-5/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_five_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-5-FAMILY-14', $package['artifact']);
    ...
    public function test_core_pages_cover_type_five_knowledge_capacity_boundary_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('5w4', $text, $key);
            $this->assertStringContainsString('5w6', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(36, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(36, array_sum($report['raw_draft_audit']['issues']));
        $this->assertCount(3, $report['raw_draft_audit']['repair_rounds']);
        $this->assertSame(1, $report['raw_draft_audit']['repair_rounds'][0]['remaining_asset_specific_issue_count']);
        $this->assertSame(1, $report['raw_draft_audit']['repair_rounds'][1]['remaining_asset_specific_issue_count']);
        $this->assertSame(0, $report['raw_draft_audit']['repair_rounds'][2]['remaining_asset_specific_issue_count']);
