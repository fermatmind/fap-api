...
final class ScanEnglishContentParityProgramCommandTest extends TestCase
{
    ...
    public function test_it_builds_a_deduplicated_read_only_program_ledger(): void
    {
        ...
        $this->writeJson($web.'/docs/seo/generated/en-content-parity-control-master.v2.json', [
        ...
        Http::fake([
            'https://fermatmind.com/sitemap.xml' => static fn () => Http::response('<?xml version="1.0"?><urlset><url><loc>https://fermatmind.com/en</loc></url><url><loc>https://fermatmind.com/zh</loc></url></urlset>', 200, ['Content-Type' => 'application/xml']),
            'https://fermatmind.com/en' => fn () => Http::response($this->html('en', 'https://fermatmind.com/en', 'English content '.str_repeat('safe content ', 20)), 200, ['Content-Type' => 'text/html']),
