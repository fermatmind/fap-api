...
final class CareerDirectory10kOpsWarmValidateCommandTest extends TestCase
{
    ...
    public function test_command_validates_directory_sitemap_and_10k_scale_budget(): void
    {
        ...
        $this->assertSame('passed', $report['capacity_chaos_gate']['status']);
        $this->assertSame(10000, $report['capacity_chaos_gate']['generated']['directory_items']);
        $this->assertSame(20000, $report['capacity_chaos_gate']['generated']['detail_projections']);
        $this->assertSame([50, 100], $report['capacity_chaos_gate']['traffic']['concurrency_windows']);
        $this->assertTrue($report['capacity_chaos_gate']['traffic']['search']);
        $this->assertTrue($report['capacity_chaos_gate']['traffic']['facets']);
        $this->assertSame(200, $report['capacity_chaos_gate']['traffic']['deep_page']);
        $this->assertSame('stale', $report['capacity_chaos_gate']['faults']['redis_miss_state']);
        $this->assertSame('unavailable', $report['capacity_chaos_gate']['faults']['redis_unavailable_state']);
        $this->assertTrue($report['capacity_chaos_gate']['faults']['rebuild_failure_kept_old_version']);
        ...
        $this->assertLessThanOrEqual($report['capacity_chaos_gate']['budgets']['max_memory_bytes'], $report['capacity_chaos_gate']['budgets']['memory_bytes']);
        $this->assertSame(50, $report['capacity_chaos_gate']['budgets']['max_items_per_response']);
        $this->assertSame([], $report['capacity_chaos_gate']['errors']);
