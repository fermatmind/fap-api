...
class BigFiveAuthorityV211Test extends TestCase
{
    private const DIR = 'generated/big-five-authority-v2/big5-authority-v2-range-conscientiousness-11';
    ...
    public function test_package_workflow_passes_with_eight_pages_and_closed_release_gates(): void
    {
        ...
        $this->assertSame([
            '/en/personality/big-five/conscientiousness-high',
            '/en/personality/big-five/conscientiousness-low',
            '/en/personality/big-five/conscientiousness-mid',
            '/en/personality/big-five/high-conscientiousness',
            '/en/personality/big-five/low-conscientiousness',
            '/zh/personality/big-five/conscientiousness-high',
            '/zh/personality/big-five/conscientiousness-low',
            '/zh/personality/big-five/conscientiousness-mid',
    ...
    public function test_final_package_preserves_v2_locale_pairs_and_distinct_legacy_intents(): void
    {
        ...
        $this->assertSame([
            'commitment_capacity_and_overcontrol_audit',
            'minimum_viable_structure_recovery_plan',
        ], $legacyIntents);
        $this->assertStringContainsString('selective control pattern', $v2Pairs['middle']['en']['summary']);
        $this->assertStringContainsString('选择性控制模式', $v2Pairs['middle']['zh-CN']['summary']);
    ...
    {
        $path = tempnam(sys_get_temp_dir(), 'big5-authority-v2-range-conscientiousness-');
