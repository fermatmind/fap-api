...
const isSeoCompetitiveEvidenceBoundary = (path) =>
  ...
  || /^backend\/database\/migrations\/seo_intel\/\d{4}_\d{2}_\d{2}_\d+_(?:create|expand)_seo_council_scheduler_[a-z0-9_]+\.php$/.test(path)
  || path === "deploy.php"
  || path === ".github/workflows/ci.yml"
  || path === ".github/workflows/deploy.yml"
