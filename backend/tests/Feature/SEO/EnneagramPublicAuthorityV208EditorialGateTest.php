...
final class EnneagramPublicAuthorityV208EditorialGateTest extends TestCase
{
    ...
    public function test_explicitly_negated_boundary_claims_remain_allowed(): void
    {
        foreach ([
            ...
            'Treat this observation as a revisable working hypothesis, never as diagnosis, fixed identity, ability judgment, hiring screen, relationship verdict, or forecast of career and income outcomes.',
            '本页不能预测你的职业成功。',
            '本页并非精准职业推荐。',
            '本页不是诊断或招聘适配工具。',
        ] as $limitation) {
    ...
    public function test_contrastive_negation_does_not_hide_positive_boundary_claims(): void
    {
        foreach ([
            ...
            ['This page is not a diagnosis since it predicts your career success.', 'career_or_relationship_prediction'],
            ['This page is not a diagnosis as it predicts your career success.', 'career_or_relationship_prediction'],
            ['This page is not a diagnosis as the guide predicts your career success.', 'career_or_relationship_prediction'],
            ['本页不是诊断，因为它能预测你的职业成功。', 'career_or_relationship_prediction'],
            ['本页不是诊断，所以它能预测你的职业成功。', 'career_or_relationship_prediction'],
            ['本页不是诊断，而是能预测你的职业成功。', 'career_or_relationship_prediction'],
            ['This page is not a diagnosis — predicts your career success.', 'career_or_relationship_prediction'],
            ['This page is not a diagnosis – predicts your career success.', 'career_or_relationship_prediction'],
            ['This page is not a diagnosis - predicts your career success.', 'career_or_relationship_prediction'],
            ['本页不是诊断——能预测你的职业成功。', 'career_or_relationship_prediction'],
            ['本页不是诊断--能预测你的职业成功。', 'career_or_relationship_prediction'],
