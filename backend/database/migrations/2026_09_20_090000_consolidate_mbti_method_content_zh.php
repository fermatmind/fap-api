...
return new class extends Migration
{
    ...
    {
        $package = json_decode(
            file_get_contents(__DIR__.'/../data/assessment_mbti_method_consolidation_zh_20260920.json'),
            true,
            512,
            JSON_THROW_ON_ERROR,
        );
        ...
        DB::transaction(function () use ($package, $expectedTables): void {
            ...
            foreach ($rows as $table => $row) {
                ...
                if (! is_array($localized)) {
                    throw new RuntimeException($table.' MBTI Chinese content is not an object.');
                }
