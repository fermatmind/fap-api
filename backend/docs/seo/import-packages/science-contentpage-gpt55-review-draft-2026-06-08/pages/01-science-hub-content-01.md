---
page_key: SCIENCE-HUB-CONTENT-01
page_asset_key: science
zh_title: 测评科学
en_title: Unknown
proposed_slug: /science
fallback_slug_if_nested_route_not_supported: /science
page_type: science
kind: trust_methodology_hub
review_state: science_review
science_review_required: true
legal_review_required: true
legal_review_reason: 页面使用“科学”概念并解释测评结果，需要确认不构成过度效度、诊断或职业保证声明。
status: draft
...
第一层是结果描述：你当前作答呈现了哪些倾向。
第二层是解释建议：这些倾向可能对应哪些观察角度。
第三层是行动验证：你可以通过学习、项目、访谈、工作体验或长期观察继续验证。
...
相关页面可以查看 /method-boundaries、/item-design-notes 和 /reliability-validity。相关测评可查看 /tests/mbti-personality-test-16-personality-types、/tests/big-five-personality-test、/tests/holland-career-interest-test-riasec。
