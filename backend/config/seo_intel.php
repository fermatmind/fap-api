...
return [
    ...
    // This only registers the read-model sync and never grants search-submission authority.
    ...
    'gsc_sync' => [
        ...
        'search_types' => array_values(array_filter(array_map(
            'trim',
            explode(',', (string) env('SEO_INTEL_GSC_SYNC_SEARCH_TYPES', 'web'))
        ))),
        'max_pages_per_run' => (int) env('SEO_INTEL_GSC_SYNC_MAX_PAGES', 5000),
    ],
    'gsc_foundation' => [
    ...
    'search_channel_queue' => [
        'write_enabled' => env('SEO_INTEL_SEARCH_CHANNEL_QUEUE_WRITE_ENABLED', false),
        ...
        'readiness_only_channels' => [
            'google_sitemap',
            'gsc_readiness',
            'llms_queue',
        ],
        'future_submission_channels' => [
            'baidu_push',
            'indexnow',
            'so360_submit',
            'sogou_submit',
