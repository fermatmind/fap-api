...
final class SeoOpsGaokaoV5CmsDraftGateCommandTest extends TestCase
{
    ...
    private function packageFiles(): array
    {
        ...
        $base = [
            ...
            'body_visual_asset_key' => 'article.gaokao.riasec.parent-conflict.body-visual.v1',
            'body_visual_image_url' => 'https://api.fermatmind.com/storage/media-library/variants/gaokao/body_1600x900.jpg',
