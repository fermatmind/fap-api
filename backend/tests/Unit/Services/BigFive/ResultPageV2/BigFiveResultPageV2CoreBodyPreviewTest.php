...
final class BigFiveResultPageV2CoreBodyPreviewTest extends TestCase
{
    ...
    public function test_runtime_freeze_classifier_ignores_only_registered_enneagram_public_authority_v2_non_runtime_files(): void
    {
        $allowed = [
            ...
            'backend/app/Console/Commands/PersonalityEnneagramAuthorityV2RuntimeCloseout.php',
            'backend/app/Console/Commands/PersonalityEnneagramAuthorityV2RuntimeReadback.php',
            'backend/app/Console/Commands/PersonalityEnneagramAuthorityV2IntegrityGate.php',
            'backend/app/Models/PersonalityPublicContentAssetRevisionReview.php',
            ...
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV223ReviewEvidenceBinder.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV224CacheCoordinator.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV224RuntimeCloseout.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV224RuntimeManifest.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV224RuntimeReadback.php',
            ...
            'backend/database/migrations/2026_07_16_000100_create_personality_public_content_asset_revision_reviews_table.php',
        ];
        $blocked = [
            'backend/app/Console/Commands/PersonalityEnneagramAuthorityV2ReviewEvidencePublisher.php',
            'backend/app/Models/PersonalityPublicContentAssetRevisionReviewer.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV223ReviewEvidencePublisher.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV224RuntimePublisher.php',
            'backend/app/Services/Enneagram/AuthorityV2/EnneagramPublicAuthorityV2RuntimePublisher.php',
            'backend/database/migrations/2026_07_16_000101_publish_personality_public_content_asset_revision_reviews.php',
            'backend/app/Services/BigFive/ResultPageV2/BigFiveResultPageV2Service.php',
        ];
    ...
    public function test_runtime_freeze_classifier_ignores_only_big_five_authority_v2_visible_provenance_projector(): void
    {
        $allowed = [
            'backend/app/Services/BigFive/AuthorityV2/VisibleProvenance/BigFiveVisibleProvenanceProjector.php',
        ];
        $blocked = [
            'backend/app/Services/BigFive/AuthorityV2/VisibleProvenance/UnexpectedRuntimeWriter.php',
        ];
    ...
    public function test_runtime_freeze_classifier_ignores_only_big_five_authority_v2_discoverability_parity_projector(): void
    {
        $allowed = [
            'backend/app/Services/BigFive/AuthorityV2/DiscoverabilityParity/BigFiveDiscoverabilityParityProjector.php',
        ];
        $blocked = [
            'backend/app/Services/BigFive/AuthorityV2/DiscoverabilityParity/UnexpectedRuntimeWriter.php',
        ];
    ...
    public function test_runtime_freeze_classifier_ignores_only_exact_package_content_promotion_automation_files(): void
    {
        $allowed = [
            ...
            'backend/app/Services/ContentPromotion/Adapters/PersonalityCmsPromotionAdapter.php',
            'backend/app/Services/ContentPromotion/Adapters/ArticleCmsPromotionAdapter.php',
            ...
            'backend/app/Services/ContentPromotion/Adapters/EnneagramPrivateResultPromotionAdapter.php',
            'backend/app/Services/ContentPromotion/Adapters/Top100FrozenCmsBatchPromotionAdapter.php',
            ...
            'backend/app/Services/ContentPromotion/Top100FrozenCmsBatchAuthority.php',
            'backend/app/Services/ContentPromotion/Top100FrozenPackage.php',
            'backend/app/Services/ContentPromotion/ArticleCmsPromotionAuthority.php',
            'backend/app/Services/ContentPromotion/CareerCmsPromotionAuthority.php',
    ...
    public function test_runtime_freeze_classifier_ignores_mbti64_comparison_assets_dry_run_files(): void
    {
        $changed = [
    ...
    public function test_runtime_freeze_classifier_ignores_mbti_full_profile_import_dry_run_files(): void
    {
        $changed = [
            'backend/app/Console/Commands/PersonalityMbtiFullProfileImportDryRun.php',
            'backend/app/Services/Cms/MbtiFullProfileImportDryRunPlanner.php',
        ];
        $blocked = ['backend/app/Services/BigFive/ResultPageV2/BigFiveResultPageV2Service.php'];
    ...
    public function test_runtime_freeze_classifier_ignores_mbti_full_comparison_import_dry_run_files(): void
    {
        $changed = [
            'backend/app/Console/Commands/PersonalityMbtiFullComparisonImportDryRun.php',
            'backend/app/Services/Cms/MbtiFullComparisonImportDryRunPlanner.php',
        ];
    ...
    public function test_runtime_freeze_classifier_ignores_riasec_english_exact_package_dry_run_files(): void
    {
        $changed = [
    ...
    public function test_runtime_freeze_classifier_ignores_mbti_full_cms_promotion_files(): void
    {
        $changed = [
    ...
    public function test_runtime_freeze_classifier_ignores_big_five_cms_staging_write_import_files(): void
    {
        $changed = [
    ...
    public function test_runtime_freeze_classifier_ignores_security_169_guest_token_response_hardening(): void
    {
        $changed = [
    ...
    public function test_runtime_freeze_classifier_ignores_seo_intel_search_channel_queue_runtime_files(): void
    {
        $changed = [
            ...
            'backend/app/Services/SeoIntel/SearchChannelQueue/SearchChannelProviderCapabilityEvaluator.php',
    ...
    public function test_runtime_freeze_classifier_ignores_career_runtime_publish_projection_owner_changes(): void
    {
        $changed = [
            ...
            'backend/app/Domain/Career/Publish/CareerGenerationAuthorityLoader.php',
            'backend/app/Domain/Career/Publish/CareerGenerationCanonicalJson.php',
            ...
            'backend/app/Support/Career/CareerVerifyOnlyRequestAuthorizer.php',
    ...
    public function test_runtime_freeze_classifier_ignores_controlled_article_publish_sop_changes(): void
    {
        $changed = [
            ...
            'backend/app/Console/Commands/ArticleSeo13BigFiveAuthorityLabelBootstrap.php',
            ...
            'backend/app/Services/Cms/Seo13BigFiveAuthorityLabelBootstrapService.php',
    ...
    public function test_runtime_freeze_classifier_ignores_career_detail_atomic_exposure(): void
    {
        $changed = [
            ...
            'backend/app/Domain/Career/Publish/CareerRuntimePublishProjectionValidator.php',
            'backend/app/Providers/AppServiceProvider.php',
            'backend/app/Services/Analytics/CareerConversionClosureBuilder.php',
            'backend/app/Services/Career/CareerDirectoryAuthorityService.php',
            'backend/app/Services/Career/CareerIndustryDirectoryReadModel.php',
            'backend/app/Services/Career/CareerDirectoryReadModelBuilder.php',
            'backend/app/Services/Career/CareerJobDetailCacheCoverageService.php',
    ...
    public function test_runtime_freeze_classifier_ignores_career_runtime_projection_consumer_changes(): void
    {
        $changed = [
            ...
            'backend/app/Domain/Career/Publish/CareerFirstWaveLaunchReadinessAuditService.php',
    ...
    {
        $changed = [
            'backend/app/Console/Commands/PersonalityPublicAssetsRetireMediaFields.php',
            ...
            'backend/app/Support/Personality/PersonalityPublicContentMediaPolicy.php',
            ...
            'backend/database/migrations/2026_07_17_000100_remove_media_from_personality_public_content_assets.php',
            'backend/routes/api.php',
        ];
        $routeChangedLines = [
    ...
    private function mbtiImpactingRuntimeChanges(
        ...
        foreach ($changed as $file) {
            ...
            if ($this->isMbti64ComparisonAssetsDryRunFile($file)) {
                continue;
            }
            ...
            if ($this->isMbtiFullProfileImportDryRunFile($file)) {
                continue;
            }

            if ($this->isMbtiFullComparisonImportDryRunFile($file)) {
                continue;
            }
            ...
            if ($this->isRiasecEnglishPackageDryRunFile($file)) {
                continue;
            }
            ...
            if ($this->isBigFiveCmsStagingWriteImportFile($file)) {
                continue;
            }
            ...
            if ($this->isBigFiveAuthorityV2VisibleProvenanceFile($file)) {
                continue;
            }

            if ($this->isBigFiveAuthorityV2DiscoverabilityParityFile($file)) {
                continue;
            }
            ...
            if ($this->isSecurity169GuestTokenResponseHardeningFile($file)) {
                continue;
            }
            ...
            if (
                ...
                && (
                    ...
                    || $this->kernelDiffIsMbtiFullCmsPromotionOnly($kernelChangedLines ?? $this->kernelChangedLines($repoRoot, $baseRef))
    ...
    private function isMbti64ComparisonAssetsDryRunFile(string $file): bool
    {
        return in_array($file, [
            'backend/app/Console/Commands/PersonalityMbti64ComparisonAssetsDryRun.php',
            'backend/app/Services/Cms/Mbti64ComparisonAssetsDryRunPlanner.php',
    ...
    private function isMbtiFullProfileImportDryRunFile(string $file): bool
    {
        return in_array($file, [
            'backend/app/Console/Commands/PersonalityMbtiFullProfileImportDryRun.php',
            'backend/app/Services/Cms/MbtiFullProfileImportDryRunPlanner.php',
    ...
    private function isMbtiFullComparisonImportDryRunFile(string $file): bool
    {
        return in_array($file, [
            'backend/app/Console/Commands/PersonalityMbtiFullComparisonImportDryRun.php',
            'backend/app/Services/Cms/MbtiFullComparisonImportDryRunPlanner.php',
    ...
    private function isRiasecEnglishPackageDryRunFile(string $file): bool
    {
        return in_array($file, [
            'backend/app/Console/Commands/ImportRiasecEnglishPackage.php',
            'backend/app/Services/ContentImport/RiasecEnglishPackageImporter.php',
    ...
    private function isBigFiveCmsStagingWriteImportFile(string $file): bool
    {
        return in_array($file, [
            'backend/app/Console/Commands/PersonalityBigFiveCmsStagingWriteImport.php',
            'backend/app/Services/Cms/BigFiveCmsImportDraftStagingWriter.php',
    ...
    private function isBigFiveAuthorityV2VisibleProvenanceFile(string $file): bool
    {
        return $file === 'backend/app/Services/BigFive/AuthorityV2/VisibleProvenance/BigFiveVisibleProvenanceProjector.php';
    }
    ...
    private function isSecurity169GuestTokenResponseHardeningFile(string $file): bool
    {
        return $file === 'backend/app/Http/Controllers/API/V0_3/AuthGuestController.php';
    }
...
DIFF;
     ...
     * @param  list<string>  $changedLines
     */
    private function kernelDiffIsMbtiFullCmsPromotionOnly(array $changedLines): bool
    {
        if ($changedLines === []) {
            return false;
        }
        ...
        foreach ($changedLines as $line) {
            $normalized = ltrim($line, '+-');
            if (preg_match('/\\bPersonalityMbtiFullCmsPromote\\b/u', $normalized) !== 1) {
                return false;
            }
        }
     ...
     * @param  list<string>  $changedLines
     */
    private function kernelDiffIsBigFiveCmsStagingWriteImportOnly(array $changedLines): bool
    {
        if ($changedLines === []) {
            return false;
        }
        ...
        foreach ($changedLines as $line) {
            $normalized = ltrim($line, '+-');
            if (preg_match('/\bPersonalityBigFiveCmsStagingWriteImport\b/u', $normalized) !== 1) {
                return false;
            }
        }
     ...
     * @param  list<string>  $changedLines
     */
    private function kernelDiffIsBigFiveCmsPreviewRenderQaOnly(array $changedLines): bool
    {
        if ($changedLines === []) {
            return false;
        }
