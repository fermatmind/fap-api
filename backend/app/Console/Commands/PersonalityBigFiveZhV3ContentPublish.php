...
final class PersonalityBigFiveZhV3ContentPublish extends Command
{
    protected $signature = 'personality:big-five-zh-v3-content-publish
        {--package=../generated/big-five-authority-v3/big5-zh-v3-52-page-release/release-package.json : Exact compiled 52-page release package}
    ...
    protected $description = 'Preflight or atomically publish the exact locked Big Five zh-CN V3 52-page cohort.';

    public function handle(BigFiveZhV3Publisher $publisher): int
    {
        try {
            ...
            $result = [
                'ok' => false,
                'status' => 'FAIL_CLOSED_BIG_FIVE_ZH_V3_52_PAGE_RELEASE',
    ...
    {
        if (! hash_equals(
            BigFiveZhV3PackageCompiler::SOURCE_CONTENT_SHA256,
        ...
        if (! hash_equals(
            BigFiveZhV3Publisher::PACKAGE_FILE_SHA256,
        ...
        if ((int) $this->option('operator-admin-user-id') !== BigFiveZhV3Publisher::OPERATOR_ADMIN_USER_ID) {
