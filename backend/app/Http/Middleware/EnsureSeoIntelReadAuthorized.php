...
final class EnsureSeoIntelReadAuthorized
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (! $this->canReadSeoIntel($user)) {
            return $this->forbiddenResponse('admin_seo_intel_read_required');
        }
    ...
    private function canReadSeoIntel(object $user): bool
    {
        foreach ([
            PermissionNames::ADMIN_SEO_INTEL_READ,
