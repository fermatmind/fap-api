...
final class EnneagramPublicAuthorityV215Type6FamilyTest extends TestCase
{
    private const PACKAGE = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-6-family-15/type-6-family-draft.json';

    private const QA_REPORT = 'docs/seo/personality/enneagram-authority-v2/enneagram-public-authority-v2-type-6-family-15/qa-report.json';
    ...
    private const FAMILY_IDENTITIES = [
        ...
        'wing:6w5',
        'wing:6w7',
        'instinctual_subtype:type-6/self-preservation',
        'instinctual_subtype:type-6/social',
        'instinctual_subtype:type-6/one-to-one',
    ];

    public function test_package_contains_exactly_the_twelve_frozen_type_six_family_targets(): void
    {
        ...
        $this->assertSame('ENNEAGRAM-PUBLIC-AUTHORITY-V2-TYPE-6-FAMILY-15', $package['artifact']);
    ...
    public function test_core_pages_cover_type_six_uncertainty_trust_boundary_and_wing_dimensions(): void
    {
        ...
        foreach ($cores as $asset) {
            ...
            $this->assertStringContainsString('6w5', $text, $key);
            $this->assertStringContainsString('6w7', $text, $key);
    ...
    public function test_qa_report_records_codex_native_review_and_zero_writes(): void
    {
        ...
        $this->assertSame(178, $report['raw_draft_audit']['asset_specific_issue_count']);
        $this->assertSame(178, array_sum($report['raw_draft_audit']['issues']));
        $this->assertCount(4, $report['raw_draft_audit']['repair_rounds']);
        $this->assertSame(3, $report['raw_draft_audit']['repair_rounds'][0]['remaining_asset_specific_issue_count']);
        $this->assertSame(0, $report['raw_draft_audit']['repair_rounds'][1]['remaining_asset_specific_issue_count']);
        $this->assertSame(2, $report['raw_draft_audit']['repair_rounds'][2]['remaining_asset_specific_issue_count']);
        $this->assertSame(0, $report['raw_draft_audit']['repair_rounds'][3]['remaining_asset_specific_issue_count']);
