...
class BigFiveAuthorityV224Test extends TestCase
{
    ...
    {
        parent::setUp();
        $this->packagePath = base_path('../generated/big-five-authority-v2/big5-authority-v2-article-core-model-24');
    }

    public function test_final_package_has_exact_batch_24_bilingual_inventory(): void
    {
        ...
        $this->assertSame([24], array_values(array_unique(array_column($package['assets'], 'batch'))));
        $this->assertCount(5, array_unique(array_column($package['assets'], 'unique_intent_key')));
    }

    public function test_every_asset_contains_complete_reader_and_evidence_structure(): void
    {
        $package = $this->readJson('final-package.json');
        ...
        foreach ($package['assets'] as $asset) {
            ...
            $this->assertNotEmpty($asset['source_mapping']);
    ...
    public function test_qa_proves_locked_scope_and_zero_release_mutations(): void
    {
        ...
        $this->assertTrue($qa['checks']['consumes_only_pr21_batch_24']);
