...
- Big Five ZH6 `solo_operator` review is a cohort-scoped exception for exact `admin_user:1`, explicit self-review, hash-locked content and complete audit evidence; it must not change global role-separation behavior. Working-revision preparation requires exactly one public, CDN-verified, authority-complete Media Library asset carrying both Hub hero and OG variants. Zero or multiple candidates remain fail closed.
