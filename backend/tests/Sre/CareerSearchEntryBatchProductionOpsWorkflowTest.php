...
final class CareerSearchEntryBatchProductionOpsWorkflowTest extends TestCase
{
    ...
    public function test_cache_refresh_resume_requires_separate_preflight_and_bounded_offline_publication(): void
    {
        ...
        foreach ([
            ...
            'FAILED_RESUME_EXECUTE_RUN_ID: "30557073777"',
            'EXPECTED_FAILED_RESUME_EXECUTE_RECEIPT_SHA256: 42bf4d8ed96513b83603a8f8aa7d2e7619a811abb9fa7691c3f5390cf7a2b203',
            'EXPECTED_FAILED_RESUME_EXECUTE_ARTIFACT_DIGEST: bc1ac3e250a1a248de072102089d2b00aacc348e43be7741f47ebb88f456f677',
            'FAILED_PERMISSION_REPAIRED_ELIGIBILITY_RUN_ID: "30587810948"',
            'FAILED_PERMISSION_REPAIRED_ELIGIBILITY_CONTROL_PLANE_SHA: 22b3d47c5d7956f215d9d1edf2ff63ddab818fb8',
            'PREFLIGHT_CONTROL_PLANE_SHA: 2284f5d9f0528722c7a58486f86c0716e526ed5c',
            'PERMISSION_REPAIR_RUN_ID: "30586605927"',
            'EXPECTED_PERMISSION_REPAIR_RECEIPT_SHA256: 346adeed33a71db9b82d2513a9728f45980c8a45724adf1df3f788a1e23dbc12',
            'EXPECTED_PERMISSION_REPAIR_ARTIFACT_DIGEST: c2256ef80b6b69958747137b9ef2e46a476b792d81192772dd62577468c343c4',
            '.failed_stage == "publish_cache_payload"',
            '.failure_category == "cache_publish_failed"',
            '.permission_metadata_write_count == 9554',
            '.repair.payload_unchanged == true',
            '.post_deploy_runner.repair_candidate_count == 0',
            '.post_php_runtime.repair_candidate_count == 0',
            'lineage-repaired cache-only resume execute',
            'failed permission-repaired eligibility run',
            '.total_count == 0 and (.artifacts | length == 0)',
            'exact quality-package and 100-URL public readback',
    ...
    public function test_thin_authority_repair_is_receipt_bound_and_exactly_five_row_scoped(): void
    {
        ...
        foreach ([
            ...
            'failed_preflight_run_id:',
            'expected_failed_preflight_receipt_sha256:',
            'expected_failed_preflight_artifact_digest:',
            'failed_crosswalk_preflight_lineage:',
            'source_workbook_release_tag:',
            'expected_preflight_receipt_sha256:',
            'expected_repair_set_sha256:',
            'expected_repair_payload_set_sha256:',
            'PASS_THIN_SOURCE_AUTHORITY_REPAIR_REQUIRED',
            'HOLD_APPROVED_WORKBOOK_UNAVAILABLE',
            'career-thin-authority-workbook-[0-9a-f]{8}-[0-9a-f]{8}',
            ...
            'Delete exact private workbook transport after repair',
            ...
            'HOLD_CROSSWALK_AUTHORITY_REPAIR_REQUIRED',
            '69d1b64c7d61467ab7a7470f69597d988dff3c70745f41ec30d0b1a43c731e08',
            'PASS_AUTHORITY_REPAIR_COMPLETE',
            'atomically create exactly ten missing reviewed-workbook occupation crosswalk rows and five normalized career display-authority rows',
            'database_write_count == 15',
            'crosswalk_write_count == 10',
            'display_write_count == 5',
            'zero persistent server write, cache write, publication, indexability, queue, sitemap, llms, Search Channel',
            'group: deploy-${{ github.repository }}-production',
        ...
        foreach ([
            ...
            'EXPECTED_CROSSWALK_REPAIR_COUNT = 10',
            'EXPECTED_COMPONENT_COUNT = 24',
            'PASS_AUTHORITY_REPAIR_PREFLIGHT',
            'HOLD_CROSSWALK_AUTHORITY_REPAIR_REQUIRED',
            'crosswalkAuthorityDiagnostics',
            'crosswalk_diagnostic_state_sha256',
            'normalizeReviewedWorkbookRow',
            'crosswalk_repair_set_sha256',
            'normalization_set_sha256',
