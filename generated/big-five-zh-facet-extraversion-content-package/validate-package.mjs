...
const [ledger, raw, review, repaired, seed] = await Promise.all([
  ...
  readJson("big_five_zh_facet_extraversion_seed.json"),
]);
...
const qaReport = {
  ...
  model_sessions: [
    { id: "codex-native-extraversion-raw-2026-07-10", mode: "codex_native_draft", external_model: false },
    { id: "codex-skeptical-review-extraversion-2026-07-10", mode: "codex_skeptical_self_review", external_model: false },
    { id: "codex-repair-extraversion-2026-07-10", mode: "codex_repair", external_model: false },
  ],
  coverage: {
    assets: 6,
    locale: "zh-CN",
  ...
  blockers: [],
  deferred: [
    "The remaining twelve Chinese Facet pages stay content_stub until their two domain PRs complete.",
