...
final class BigFiveEnglishDraftInventory
{
    ...
    {
        if (is_string($value)) {
            if (preg_match('/<(?:img|picture|source|svg|image|canvas|object|embed|iframe|video|audio|style|link|meta)\b/i', $value) === 1) {
                return true;
            }
