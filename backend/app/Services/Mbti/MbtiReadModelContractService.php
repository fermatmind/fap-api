...
final class MbtiReadModelContractService
{
    ...
    private const TELEMETRY_PARITY_FIELDS = [
        ...
        'orchestration.cta_bundle_key',
        'orchestration.cta_entry_reason',
        'orchestration.cta_softness_mode',
        ...
        'action_selection_keys',
        'recommendation_selection_keys',
        'cta_bundle_v1.bundle_key',
        'cta_bundle_v1.cta_intent',
        'cta_bundle_v1.softness_mode',
        'cta_bundle_v1.entry_reason',
        'selection_fingerprint',
