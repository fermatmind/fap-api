...
final class Eq60ReportPaywallTest extends TestCase
{
    ...
    public function test_eq60_report_contract_is_full_all_free_without_entitlement(): void
    {
        ...
        $this->assertSame('eq_report_v5_assets_science_boundary_repair_v1', (string) data_get($gate, 'report.methodology.report_version'));
        ...
        $this->assertCount(7, (array) data_get($gate, 'report.asset_refs.commercial_conversion_ids'));
        ...
        $this->assertNotEmpty((array) data_get($gate, 'report.assets.score_system.band_details'));
        $this->assertNotSame('', (string) data_get($gate, 'report.assets.core_formulation.title'));
        $this->assertNotSame('', (string) data_get($gate, 'report.assets.result_snapshot.core_judgment'));
        $this->assertCount(7, (array) data_get($gate, 'report.assets.commercial_conversion_actions'));
        $this->assertNotSame('', (string) data_get($gate, 'report.assets.quality_confidence.why_this_level'));
        $this->assertNotEmpty((array) data_get($gate, 'report.assets.psychometric_evidence_status'));
